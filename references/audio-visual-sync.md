...
- **"One idea per beat" — each `sceneProps` entry should map to exactly one visual concept per VO sentence.** Stacking two ideas onto one beat dilutes both.
...
## 4. Common sync failures and fixes
