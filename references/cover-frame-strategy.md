...
If it fails, adjust the cold-open section in the renderer data file or the design tokens, then re-render the hook. Do not present the hook with a weak cover frame and hope the video saves it.
