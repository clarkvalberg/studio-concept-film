...
Useful if you want to read the source, extend the skill, or contribute back.
...
See [CONTRIBUTING.md](../CONTRIBUTING.md). Most extension happens in either `references/` (frameworks, rules) or `assets/remotion-template/src/compositions/scenes/` (new scene types).
